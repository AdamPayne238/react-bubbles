...
Private routes can be used to get data secure. Routes for admins and routes for members as well as routes for the public that have not yet signed up for services can seperate what data is accessible.
- [ ] Describe how web servers work.
Web servers hold information to be retrieved.
